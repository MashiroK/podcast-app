    ...
    <div class="modal__container">
        ...
        <div class="option">
            <p>Tem certeza que deseja excluir
                sua conta permanentemente?</p>
        </div>

        <div class="delete__acc">
            <a href="./login.php">
                EXCLUIR
            </a>
        </div>
